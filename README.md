...
Добрый день! Меня зовут Александр, я Junior Manual QA. Я не боюсь фразы: "У нас нет ТЗ, но нужно ВСЁ протестировать!". Люблю backend-тестирование, хотя и frontend мне не чужд<br>
...
[Сертификат "Stepik.Интерактивный тренажер по SQL"](https://stepik.org/cert/2129689)
